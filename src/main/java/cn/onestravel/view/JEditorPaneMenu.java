...
public class JEditorPaneMenu extends JEditorPane implements MouseListener, KeyListener, UndoableEditListener {
    ...
    public JEditorPaneMenu() {
        super();
        init();
    }

    public JEditorPaneMenu(URL initialPage) throws IOException {
        super(initialPage);
        init();
    }

    public JEditorPaneMenu(String url) throws IOException {
        super(url);
        init();
    }

    public JEditorPaneMenu(String type, String text) {
        super(type, text);
        init();
    }
